(this.jordle = this.jordle || {}),
  (this.jordle.bundle = (function (e) {
    "use strict";
    function a(e) {
      return (a =
    ...
    var j = "darkTheme",
      ...
      _ = (function (e) {
        ...
        function t() {
          ...
          return (
            !0 === o || !1 === o ? e.setDarkTheme(o) : n && e.setDarkTheme(!0),
      ...
      va =
        ...
        fa(function (e, s) {
          var t = -1,
            ...
            n = o > 2 ? s[2] : void 0;
          for (
            r = ka.length > 3 && "function" == typeof r ? (o--, r) : void 0,
              n &&
                (function (e, s, t) {
                  if (!D(t)) return !1;
                  var o = a(s);
    ...
    Da("config", "G-2SSGMHY3NP", {
      app_version:
        null === (Ha = window.jordle) || void 0 === Ha ? void 0 : Ha.hash,
      debug_mode: !1,
    });
          ...
          o(t, [
            {
              ...
              value: function () {
                if (5 === this.tileIndex && !(this.rowIndex >= 6)) {
                  ...
                  if (((e = s), !La.includes(e) && !Aa.includes(e)))
                    return (
                  ...
                  if (i || l)
                    Xa({
                      ...
                      isStreak:
                        ...
                        1 === $a(new Date(this.lastCompletedTs), new Date()),
            ...
            },
            {
              ...
              value: function () {
                ...
                this.shadowRoot
                  ...
                  .appendChild(Va.content.cloneNode(!0)),
                  this.shadowRoot
          ...
          o(t, [
            {
              ...
              value: function () {
                ...
                for (
                  ...
                  if (
                    ((d.style.width = "".concat(l, "%")), "number" == typeof n)
                  ) {
    ...
    return (
      customElements.define("countdown-timer", Es),
      (e.CountdownTimer = Es),
      (e.GameApp = ss),
      (e.GameHelp = ks),
      (e.GameIcon = js),
